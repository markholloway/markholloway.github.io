...
In other cases malicious users may obtain numbers in bulk with the intention of using them for fraud. Lookup can deifferentiate easily obtainable `VoIP` numbers from other landline and mobile numbers.
